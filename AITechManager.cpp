...
{
	Player[aiPlayerIndex].MarkResearchComplete(TechID::techLargeScaleOpticalResonators);
	Player[aiPlayerIndex].MarkResearchComplete(TechID::techFocusedMicrowaveProjection);
}
